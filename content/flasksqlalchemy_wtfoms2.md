...
[Flask-WTF](https://flask-wtf.readthedocs.io/en/stable/){:target="_blank"}はValidationやCSRF対策を施したフォームを作成するためのFlask拡張。  
...
各種設定はFlask-WTFではなく本家[WTForms](https://wtforms.readthedocs.io/en/stable/){:target="_blank"}のドキュメントをチェックしてください。
